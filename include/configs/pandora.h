 ...
 *
 * X-Loader Configuation settings for the Pandora OMAP3530 board.
 *
...
#define CONFIG_OMAP34XX          1    /* which is a 34XX (well 35XX) */
#define CONFIG_OMAP3430          1    /* which is in a 3430 (well 3530) */
#define CONFIG_OMAP3_PANDORA     1    /* working with a Pandora */

/* Uncomment this for final boards (ones with BT/WiFI) */
/* #define CONFIG_PANDORA_FINAL	 1 */

/* Enable the macro below if MMC boot support is required */
#define CONFIG_MMC	1
